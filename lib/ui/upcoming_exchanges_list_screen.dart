...
const SnackBar(content: Text("Create exchange coming next")),
);
...
body: Center(child: Text("No case selected")),
);
}
...
/// ================================
appBar: AppBar(
title: const Text("Upcoming Exchanges"),
),
...
const Text("No upcoming exchanges",
style: PLDesign.sectionTitle),
...
ElevatedButton.icon(
onPressed: createExchange,
icon: const Icon(Icons.add),
label: const Text("Schedule Exchange"),
),
],
),
),
...
border: Border.all(color: PLDesign.primary),
